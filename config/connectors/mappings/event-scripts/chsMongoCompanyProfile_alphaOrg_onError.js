...
logger.error('[CH-SYNC][MONGO-COMPANY-TO-ALPHA-ORG][ERROR] Source object: ' + JSON.stringify(source))
try {
    logger.error('[CH-SYNC][MONGO-COMPANY-TO-ALPHA-ORG][ERROR] Sync chsMongoCompanyProfile_alphaOrg - error: ' + JSON.stringify(target))
} catch (e) {
